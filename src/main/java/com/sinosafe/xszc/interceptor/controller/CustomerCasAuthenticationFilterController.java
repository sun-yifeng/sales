 ...
 * @author Rob Winch
 */
public class CustomerCasAuthenticationFilterController extends AbstractAuthenticationProcessingFilter {
    ...
    public CustomerCasAuthenticationFilterController() {
	...
	@Autowired
	@Qualifier("SessionTimeoutProcessService")
	private SessionTimeoutProcessService sessionProcess;
    ...
    protected final void successfulAuthentication(HttpServletRequest request,
        ...
        if(!continueFilterChain) {
            ...
            sessionProcess.fillSession(request, response);
            return;
        }
    ...
    /**
     * Determines if the {@link CustomerCasAuthenticationFilterController} is configured to handle the proxy receptor requests.
     *
     * @return
     */
     ...
     * {@link CustomerCasAuthenticationFilterController#setProxyAuthenticationFailureHandler(AuthenticationFailureHandler) will be used for proxy requests
     * that fail. The value {@link CustomerCasAuthenticationFilterController#setAuthenticationFailureHandler(AuthenticationFailureHandler)} will be used for
