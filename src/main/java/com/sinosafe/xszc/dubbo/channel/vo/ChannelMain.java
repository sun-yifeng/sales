package com.sinosafe.xszc.dubbo.channel.vo;
...
public class ChannelMain implements java.io.Serializable{
	...
	private java.sql.Timestamp tAdbTm;
  ...
  public static long getSerialversionuid() {
	...
	public java.sql.Timestamp gettAdbTm() {
		return tAdbTm;
	}

	public void settAdbTm(java.sql.Timestamp tAdbTm) {
		this.tAdbTm = tAdbTm;
	}
