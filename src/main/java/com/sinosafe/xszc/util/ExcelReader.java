  ...
  //判断从Excel文件中解析出来数据的格式  
    ...
    private String getCellFormatValue(HSSFCell cell) {
        ...
        if (cell != null) {
            ...
            case HSSFCell.CELL_TYPE_NUMERIC:
            	String cellvalueStr = ""+cell.getNumericCellValue();
            	BigDecimal bd = new BigDecimal(cellvalueStr);
            ...
            case HSSFCell.CELL_TYPE_FORMULA: {
                ...
                // 如果是纯数字
                	...
                	//System.out.println(decimalFormat.format(cellV));
                    cellvalue = decimalFormat.format(cellV);
                }
                break;
            }
            // 如果当前Cell的Type为STRIN
