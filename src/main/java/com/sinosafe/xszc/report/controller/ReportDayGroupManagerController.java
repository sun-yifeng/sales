...
import com.sinosafe.xszc.report.service.ReportDayGroupManagerService;
...
@Controller
@RequestMapping("/reportGroupManagerTrace")
public class ReportDayGroupManagerController {

	private static final Log log = LogFactory.getLog(ReportDayGroupManagerController.class);
	
	@Autowired
	@Qualifier("ReportDayGroupManagerService")
	private ReportDayGroupManagerService reportDayGroupManagerService;
	 ...
	 */
	@RequestMapping("/queryReportGroupManagerTrace")
	public void queryReportGroupManagerTrace(HttpServletRequest request, HttpServletResponse response, FormDto dto) throws GeneralException {
		...
		try {
			pageDto = reportDayGroupManagerService.findReportDayGroupManagerByWhere(pageDto);
		} catch (Exception e) {
			log.error(e);
	...
	public void queryDataToExcel(HttpServletRequest request, HttpServletResponse response, FormDto dto) throws GeneralException {
		...
		try {
			...
			String strFileName ="reportDayGroupManagerModel.xls";
