...
import static com.sinosafe.xszc.sqlmapper.MapperNameSpace.REPORT_DAY_SALE_TRACE;
...
public class ReportDaySaleTraceServiceImpl implements ReportDaySaleTraceService {
	...
	public PageDto findReportDaySaleTraceByWhere(PageDto pageDto) {
		Long total = dao.selectOne(REPORT_DAY_SALE_TRACE + QUERY_COUNT, pageDto.getWhereMap());
		...
		List<Map<String, Object>> resultList = dao.selectList(REPORT_DAY_SALE_TRACE + QUERY_LIST_PAGE, pageDto.getWhereMap());
	...
	public PageDto queryDataToExcel(PageDto pageDto) {
		...
		List<Map<String, Object>> rows = dao.selectList(REPORT_DAY_SALE_TRACE + QUERY_LIST_PAGE, pageDto.getWhereMap());
