...
import static com.sinosafe.xszc.sqlmapper.MapperNameSpace.REPORT_WEEK_AGENT_CHANNEL;
...
public class ReportWeekAgentChannelServiceImpl implements ReportWeekAgentChannelService {
	...
	public PageDto findReportWeekAgentChannelByWhere(PageDto pageDto) {
		Long total = dao.selectOne(REPORT_WEEK_AGENT_CHANNEL + QUERY_COUNT, pageDto.getWhereMap());
		...
		List<Map<String, Object>> rows = dao.selectList(REPORT_WEEK_AGENT_CHANNEL + QUERY_LIST_PAGE, pageDto.getWhereMap());
