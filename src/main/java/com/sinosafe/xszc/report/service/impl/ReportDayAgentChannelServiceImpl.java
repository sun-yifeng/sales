...
import static com.sinosafe.xszc.sqlmapper.MapperNameSpace.REPORT_DAY_AGENT_CHANNEL;
...
public class ReportDayAgentChannelServiceImpl implements ReportDayAgentChannelService {
	...
	public PageDto findReportDayAgentChannelByWhere(PageDto pageDto) {
		Long total = dao.selectOne(REPORT_DAY_AGENT_CHANNEL + QUERY_COUNT, pageDto.getWhereMap());
		...
		List<Map<String, Object>> rows = dao.selectList(REPORT_DAY_AGENT_CHANNEL + QUERY_LIST_PAGE, pageDto.getWhereMap());
	...
	public PageDto queryParentDept(PageDto pageDto) {
		...
		List<Map<String, Object>> rows = dao.selectList(REPORT_DAY_AGENT_CHANNEL + QUERY_PARENT_DEPT, pageDto.getWhereMap());
		pageDto.setRows(rows);
		return pageDto;
	}
	...
	public PageDto queryDeptName(PageDto pageDto) {
		// TODO Auto-generated method stub
		List<Map<String, Object>> rows = dao.selectList(REPORT_DAY_AGENT_CHANNEL + QUERY_DEPT, pageDto.getWhereMap());
		pageDto.setRows(rows);
		return pageDto;
	}
