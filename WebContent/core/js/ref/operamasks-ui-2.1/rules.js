$(function(){
    ...
    $.omRules.lang={
            ...
            noLetterAndInteger:"不是英文、数字或英文+数字",
            notLetter:"不是英文字母",
            notDomain:"不是合法的域认证地址",
            noChinese:"不能输入中文"
    };
    /**
     * ruleName : isNum
    ...
    $.validator.addMethod("isChineses", function(value) {
        return checkChineses(value);
    }, $.omRules.lang.notChineses);
    /**
     * ruleName : isEmail
     */
     ...
     * ruleName : isLetter
     */
    $.validator.addMethod("isLetter", function(value) {
        return isLetter(value);
    }, $.omRules.lang.notLetter);
    /**
     * ruleName : isLetterAndInteger
     */
    $.validator.addMethod("isLetterAndInteger", function(value) {
    	return isLetterAndInteger(value);
    }, $.omRules.lang.noLetterAndInteger);
    /**
     * ruleName : isNotChinese
     */
    $.validator.addMethod("isNotChinese", function(value) {
    	return isNotChinese(value);
    }, $.omRules.lang.noChinese);
    /**
     * ruleName : isLetterAndInteger
     */
    $.validator.addMethod("isDomian", function(value) {
    	return checkDomain(value);
    }, $.omRules.lang.notDomain);
...
function checkMobilePhone(str){
	if(checkNull(str)){		
		...
		if(str.match(/(^[1][3578][0-9]{9}$)/) == null){
	        return false;
	    }
	    else {
	        return true;
...
//判断是否为英文、数字或英文+数字
function isLetterAndInteger(str){
...
function checkDomain(str){
    if (str.match(/(http[s]?|ftp|ladp):\/\/[^\/\.]+?\..+\w$/i) == null) {
        return false
    }
    else {
        return true;
