 ...
 function initValidate(){
	...
	remote = $("#addVirtualForm").validate({
         ...
         submitHandler : function() {
        	 ...
        	 //提交保存入库
     		Util.post("<%=_path%>/recommender/saveRecommender.do",$("#addVirtualForm").serialize(), 
					function(data) {
     			  /*$.omMessageBox.alert({
			           content:'新增团队信息成功!',
			           onClose:function(v){
	...
	<div>
		...
		<legend>个人推荐人信息</legend>
			<form id="addVirtualForm">
				<input type="hidden" name="formMap['deptCode']" id="deptCode"/>
				<input type="hidden" name="formMap['deptCname']" id="deptCname">
				<table style="padding-left:30px;">
					<tr>
						<td style="padding-left:30px" align="right"><span class="label">个人代理人编码：</span></td>
						<td><input name="formMap['channelCode']"  id="channelCode" readonly="readonly" onclick="selAgent();" /><span style="color:red">*</span></td>
