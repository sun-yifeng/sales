...
var tableCols = eval([
    ...
    {header:"远程出单点销售团队代码", name:"remoteCde", like:true},
...
var tableHead = [
   ...
   [
	...
	{header:tableCols[5].header,name:tableCols[5].name,rowspan:2,width:250},
	...
	{header:tableCols[10].header,name:tableCols[10].name,rowspan:2,width:250},
...
<body>
	<form id="filterFrm">
	    ...
	    <input type="hidden" name="formMap['tableName']" id="tableName" value="REPORT_WEEK_REMOTE_POLICY_NEW"/>
	    <input type="hidden" name="formMap['excelName']" id="excelName" value="reportWeekRemotePolicyNew"/>
		<div id="search-panel">
			<table >
				<tr>
