...
var tableCols = eval([
    ...
    {header:"险种", name:"insureCode", equal:true},
...
<body>
	<form id="filterFrm">
	    ...
	    <input type="hidden" name="formMap['tableName']" id="tableName" value="REPORT_WEEK_SALE_TRACE_INSURE"/>
	    <input type="hidden" name="formMap['excelName']" id="excelName" value="reportWeekSaleTraceInsureType"/>
		<div id="search-panel">
			<table >
				<tr>
					...
					<td><input type="text" name="formMap['insureCode']" id="insureCode" class="sele"/></td>
					...
					<td><input type="text" name="formMap['reportWeek']" id="reportEndWeek" value="" class="sele"/></td>
				</tr>
				<tr>		
					<td colspan="10" style="padding-left:15px;" align="right"><span id="button-search" onclick="query(1)">查询</span><span id="button-dataToExcel" onclick="query(2)">导出Excel</span></td>
				</tr> 
			</table>
		</div>
	</form>
