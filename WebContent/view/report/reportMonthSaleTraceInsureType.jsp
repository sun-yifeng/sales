...
<body>
	<form id="filterFrm">
	    ...
	    <input type="hidden" name="formMap['tableName']" id="tableName" value="REPORT_MONTH_SALE_TRACE_INSURE"/>
	    <input type="hidden" name="formMap['excelName']" id="excelName" value="reportMonthSaleTraceInsureType"/>
		<div id="search-panel">
			<table >
				<tr>
