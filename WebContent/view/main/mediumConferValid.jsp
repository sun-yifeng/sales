...
$(function(){
	...
	//查询面板
	var searchPanelTitle = "系统提示信息  > 合作机构协议到期列表";
...
var tabHand = [
    [
	    ...
	    {header:"渠道",name:"CHANNELNAME",width:300,align:'center'},
	    {header:"协议号",name:"CONFERID",width:200,align:'center'},
		{header:"协议生效日期",name:"VALIDDATE",width:120,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		},
		{header:"协议期满日期",name:"EXPIREDATE",width:120,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		}
...
//查询操作
function query() {
	$("#tables").omGrid("setData","<%=_path%>/queryMediumConferValidList.do?"+$("#filterFrm").serialize());
