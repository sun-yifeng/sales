...
$(function(){
	...
	//查询面板
	var searchPanelTitle = "系统提示信息  > 个人代理协议到期列表";
...
var tabHand = [
    [
	    ...
	    {header:"代理人",name:"CHANNELNAME",width:150,align:'center'},
	    {header:"协议号",name:"CONFERID",width:200,align:'center'},
		{header:"协议生效日期",name:"VALIDDATE",width:150,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		},
		{header:"协议期满日期",name:"EXPIREDATE",width:150,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		}
...
//查询操作
function query() {
	$("#tables").omGrid("setData","<%=_path%>/queryAgentConferValidList.do?"+$("#filterFrm").serialize());
