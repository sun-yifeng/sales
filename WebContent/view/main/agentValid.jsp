...
$(function(){
	...
	//查询面板
	var searchPanelTitle = "系统提示信息  > 个人代理人执业证书到期提醒列表";
...
var tabHand = [
    [
		{header:"经办机构",name:"DEPTCODE",width:150,align:'center',
	    ...
	    {header:"代理人",name:"CHANNELNAME",width:100,align:'center'},
	    {header:"代理人编码",name:"CHANNELCODE",width:100,align:'center'},
	    /*{header:"许可证号",name:"LICENCE",width:150,align:'center'},
		{header:"许可证颁发日期",name:"LICENSEVALIDDATE",width:110,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		},
		{header:"许可证期满日期",name:"LICENSEEXPIREDATE",width:110,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		},
		{header:"展业证号",name:"BUSINESSNO",width:150,align:'center'},
		{header:"展业证生效日期",name:"BUSINESSVALIDDATE",width:110,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		},
		{header:"展业证期满日期",name:"BUSINESSEXPIREDATE",width:110,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		},*/
		{header:"执业证号",name:"QUALIFICATIONNO",width:200,align:'center'},
		{header:"执业证生效日期",name:"QUALIFICATIONVALIDDATE",width:120,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		},
		{header:"执业证期满日期",name:"QUALIFICATIONEXPIREDATE",width:120,align:'center',
			renderer : function(value, rowData , rowIndex){
				return formatDate(value,"yyyy-MM-dd");
			}
		}
...
//查询操作
function query() {
	$("#tables").omGrid("setData","<%=_path%>/queryAgentValidList.do?"+$("#filterFrm").serialize());
		...
		<div id="search-panel">
			<table>
				<tr>
					...
					<td align="left"><input name="formMap['deptCode']" id="deptCode" style="width:100px;" /></td>
					<td align="right"><span class="label">业务线：</span></td>
					<td align="left"><input class="sele" name="formMap['lineCode']" id="lineCode" style="width:100px;" /></td>
					<td align="right"><span class="label">代理人名称：</span></td>
					<td align="left"><input name="formMap['channelName']" id="channelName" style="width:118px;" /></td>
