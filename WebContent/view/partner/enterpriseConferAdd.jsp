        ...
        submitHandler:function() {
            ...
            Util.post("<%=_path%>/confer/saveConfer.do",$("#baseInfo").serialize(), function(data) {
                    ...
                    $.omMessageBox.alert({
                        ...
                        content:'协议保存成功',
                        onClose:function(value){
                            window.location.href = "enterpriseEdit.jsp?flag=1&channelCode="+channelCode;
                            return true;
                        }
                    });
            });
...
//重置
function reset(){
    window.location.href = "enterpriseConferAdd.jsp?channelCode="+channelCode+"&mediumCname="+mediumCname+"&deptCode="+deptCode+"&deptName="+deptName;
}
        ...
        <form id="baseInfo">
            ...
            <fieldSet>
                <legend>基本信息</legend>
                    <table>
                        <tr>
                          	<input type="hidden" name="channelFlag" id="channelFlag" value="<%=channelFlag %>"/>
