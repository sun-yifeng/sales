        ...
        submitHandler : function() {
            ...
            Util.post("<%=_path%>/confer/updateConfer.do",$("#baseInfo").serialize(), function(data) {
                ...
                $.omMessageBox.alert({
                    ...
                    content: '协议保存成功',
                    onClose: function(value){
                      window.location.href = "individualEdit.jsp?flag=2&channelCode="+channelCode + "&channelFlag=<%=channelFlag%>";
                    return true;
                   }
                });
            });
...
//取消操作
function cancel(){
    window.location.href = "individualEdit.jsp?flag=1&channelCode="+channelCode + "&channelFlag=<%=channelFlag%>";
}
</script>
</head>
<body>
