...
$(function(){
	...
	//limit : getLawImpTypeList(versionId).length*30,
	$("#tables").omGrid({
      	limit : "0",
        height: 480,
...
<body>
	<form id="filterFrm">
			...
			<table>
				<tr>
					...
					<td style="padding-left:15px" align="right"><span class="label">团队名字：</span></td>
					<td><input class="sele" name="formMap['groupName']" id="groupName" /></td>
	...
	<div id="impXlsArea" style="display:none">
	    ...
	    <form action="<%=_path %>/lawImpValue/impGroupValueInXls" id="impXlsForm" method="post" class="easyWebForm" target="submitFrame" enctype="multipart/form-data">
