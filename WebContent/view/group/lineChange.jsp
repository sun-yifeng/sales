            			 	...
            			 	icons : {left : '<%=_path%>/images/op-edit.png'},
            	 		 	...
            	 		 	var rows = $('#tables').omGrid("getSelections",true);
            	 		 		...
            	 		 		if(row.length == 0){
            		            	...
            		            	window.location.href = "lineChangeEdit.jsp?salesmanCode="+row[0].salesmanCode+"&deptCode="+row[0].deptCode+"&parentDeptCode="+row[0].deptCodeTwo;
            	 		 		}
            	 		 	}
            	        },
            	{separtor:true},
    			 	...
    			 	icons : {left : '<%=_path%>/images/trace.png'},
    	 		 	onClick:function(){
    	 		 		...
    	 		 		if(row.length != 1){
    	 		 			...
    	 		 			window.location.href = "lineChangeHistory.jsp?salesmanCode="+row[0].salesmanCode;
    	 		 		}
    	 		 	}
    	        }
            	]
...
function setHand(){
	...
	result.push({header:"转正日期",name:"entryDate", width:110});
		...
		<div id="search-panel">
			<table>
				<tr>
					...
					<td><input class="sele"   name="formMap['businessLine']"  id="businessLine" /></td>
				</tr>
				<tr>
