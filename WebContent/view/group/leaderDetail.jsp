...
function cancel(){
	window.location.href = "leaderHistory.jsp?groupCode="+groupCode;
}
</script>
</head>
<body>
					...
					<form id="updateSaleGroup">
						...
						<table style="padding-left: 30px;">
							<tr>
								...
								<input type="text" name="deptCode" id="deptCode" value="" style="display: none;"/></td>
			                    </tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="updatedUser"  id="updateUser"  class="sele2"  readonly="readonly"/></td>
								<td style="padding-left: 30px;" align="right"><span class="label">修改时间：</span></td>
								<td><input  type="text" name="updatedDate2"  id="updateDate2"  class="sele2" readonly="readonly"/></td>
							</tr>
							     <td style="padding-left:30px;" align="right"><span class="label">团队长名字：</span></td>
							     <td><input  type="text" name="salesmanCname"  id="salesmanCname"  class="sele2" readonly="readonly"/></td>
							     <td style="padding-left:30px;" align="right"><span class="label">团队长销售职级：</span></td>
							     <td><input  type="text" name="rankName"  id="rankName"  class="sele2" readonly="readonly"/></td>
						</table>
					</form>
				</fieldSet>
			</div>
