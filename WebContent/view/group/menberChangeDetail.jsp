...
//取消
function back(){
	window.location.href = "menberChangeHistory.jsp?salesmanCode="+salesmanCode;
}
			...
			<fieldSet>
				...
				<form id="leaderCancelFrm">
					...
					<table style="padding-left: 30px;">
						...
						<tr>
							<td style="padding-left: 15px; " align="right">异动生效期：</td>
							<td><input type="text" name="validDate"  id="validDate"  style="width: 150px;" readonly="readonly"/></td>
							<td style="padding-left: 30px; " align="right">失效期：</td>
							<td><input type="text" name="invalidDate" id="invalidDate"  style="width: 150px;" readonly="readonly"/></td>
