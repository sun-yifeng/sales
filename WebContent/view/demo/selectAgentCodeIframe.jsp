...
$(document).ready(function(){
         			 	...
         			 	icons : {left : '<%=_path%>/images/op-edit.png'},
         	 		 	onClick:function(){
         	 		 		...
         	 		 		if(row.length != 1){
 	       	 		 		...
 	       	 		 		window.parent.fillAgentBackAndCloseDialog(rows[0]);
         	 		 		}
         	 		 	}
         	        }
         	]
    ...
    $('#tables').omGrid({
        ...
        colModel : [{header:"经办部门代码",name:"deptCode",width:80},
                	...
                	{header:"代理人代码",name:"channelCode",width:100},
                	{header:"代理人名称",name:"channelName",width:220},
                	],
        onRowDblClick : function(rowIndex,rowData,event){
              window.parent.fillAgentBackAndCloseDialog(rowData);
        }
    });
...
<form id="filterFrm">
		<div id="search-panel" class="search-panel">
			<input type="hidden" name="formMap['queryPageFlag']" id="queryPageFlag" value="0" style="width:120px"/>
			<table class="fontClass">
				<tr>
					<td style="padding-left:30px" align="right"><span class="label">代理人代码：</span></td>
					<td><input name="formMap['channelCode']" id="channelCode" style="width:120px" /></td>
					<td style="padding-left:30px" align="right"><span class="label">代理人名称：</span></td>
					<td><input type="text" name="formMap['channelName']" id="channelName" style="width:120px" />
