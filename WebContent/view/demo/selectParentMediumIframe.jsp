...
$(document).ready(function(){
    ...
    $('#tables').omGrid({
        ...
        colModel : [{header:"经办部门代码",name:"deptCode",width:80},
                	...
                	{header:"代理渠道名称",name:"mediumCname",width:180},
                	/* {header:"经办部门",name:"processDeptCode",width:100}, */
                	{header:"状态",name:"status",width:80},
                	{header:"合作层级",name:"parterLevel",width:80}],
...
function query(){
	// 取父页面机构
	$("#deptCode").val($("#deptCode", parent.document).val());
	$("#processDeptCode").val($("#processDeptCode", parent.document).val());
	// 查询父亲渠道
	$("#tables").omGrid("setData","<%=_path%>/medium/queryParentChannel.do?"+$("#filterFrm").serialize());
}
</script>
</head>
<body>
<form id="filterFrm">
		<div id="search-panel" class="search-panel">
		    ...
		    <input name="formMap['processDeptCode']" id="processDeptCode" type="hidden" />
			<table class="fontClass">
				<tr>
					...
					<td><input type="text" name="formMap['mediumCname']" id="mediumCname" style="width:120px" /></td>
