...
function disFn(date) {
    ...
    if (date < nowMiddle) {//如果日期小于当前日期，置灰
        return false;
    }
}
			...
			<legend class="fontClass" style="margin-left: 40px;">基本信息</legend>
				...
				<table class="fontClass" style="">
					<tr>
		                ...
		                <td  nowrap><input type="text" disabled="disabled" name="noticId" id="noticId"/>
					...
					<tr>
		                ...
		                <td  nowrap>
		                	<input class="omRequired" name="tiltle" id="tiltle"/>
		                ...
		                <td><input class="omRequired omIsNum" name="feedbackDay" id="feedbackDay" />
		                <span class="color_red">*</span>
		                </td>
					...
					<tr>
		                ...
		                <td ><input class="sele omRequired" name="period" id="period" />
		                <span class="color_red">*</span></td>
		                <td>
		                <span class="errorImg"></span><span class="errorMsg" ></span></td>
					...
					<tr>
		                ...
		                <td  colspan="7">
		                	<textarea rows="8" cols="102" class="omRequired "  omMaxLength=300 name="content" id="content" ></textarea>
		                </td>
					...
					<tr>
		                ...
		                <td colspan="5"><div id="receiveDept"></div>
		                </td>
