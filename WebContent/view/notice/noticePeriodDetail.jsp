			...
			<legend class="fontClass" style="margin-left: 40px;">基本信息</legend>
				...
				<table class="fontClass" style="">
					...
					<td width="120px" align="right" nowrap><span class="label">公告标题：</span></td>
		                <td  nowrap><input class="omRequired" readonly="readonly" name="tiltle" id="tiltle"/>
		                ...
		                <td  nowrap><input class="omRequired" readonly="readonly" name="publisher" id="publisher"/>
		                <span class="color_red">*</span></td>
		                <td>
		                <span class="errorImg"></span><span class="errorMsg" ></span></td>
					...
					<tr>
		                ...
		                <td  colspan="7"><textarea rows="8" cols="102" class="omRequired" readonly="readonly" name="content" id="content"></textarea>
		                </td>
